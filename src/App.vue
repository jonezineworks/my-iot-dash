...
export default {
  ...
  methods: {
    saveConfig(){
      localStorage.setItem("myIotServer", this.myIotServer);
      localStorage.setItem("isSolar", this.isSolar);
    },
    connectWebsocket() {
      let that = this;
  ...
  mounted() {
    if (localStorage.getItem("myIotServer")) {
      this.myIotServer = localStorage.getItem("myIotServer");
    }
    if (localStorage.getItem("isSolar")) {
      this.isSolar = localStorage.getItem("isSolar") === 'true';
    }
  ...
  <div class="vh-100 vh-100 m-0 text-light bg-dark d-flex flex-column">
    <div class="flex-fill d-flex justify-content-center align-content-center">
      ...
      <div class="m-auto">
        ...
        <h2><span class="">{{ houseData.Today }}</span> <span class="text-info small ">KWh</span></h2>
        ~{{ (houseData.Today * 0.14).toFixed(2) }} <span class="text-info ">€</span>
      </div>
      <div class="m-auto" v-if="isSolar">
        ...
        <p class="mb-0 text-secondary">Total Hoje</p>
        <h2><span class=""> {{ solarData.Today }}</span> <span class="text-info small ">KWh</span></h2>
    ...
    <div class="m-4 d-flex justify-content-between align-items-center">
      ...
      <span class="text-dark-emphasis">{{myIotServer}}</span>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <label for="myIotServerInput" class="form-label">myIotServer Address</label>
              <div class="input-group mb-3">
                <input type="text" class="form-control" id="myIotServerInput" aria-describedby="basic-addon3" v-model="myIotServer">
              </div>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="saveConfig()">Save changes</button>
            </div>
          </div>
        </div>
      </div>
