  ...
  <div class="flex-fill d-flex flex-column p-4 overflow-hidden">
    ...
    <div class="row flex-fill overflow-hidden">
      ...
      <div class="col-8 h-100">
        <div class="lucien-card h-100">
          <div class="lucien-card-inner d-flex flex-column align-items-center justify-content-center">
            ...
            <svg viewBox="0 0 400 200" class="w-100 h-auto" style="max-height: 300px;">
              ...
              <rect x="10" y="100" width="40" height="80" fill="#5c9cff" rx="4" />
              <rect x="60" y="80" width="40" height="100" fill="#5c9cff" rx="4" />
              <rect x="110" y="120" width="40" height="60" fill="#5c9cff" rx="4" />
              <rect x="160" y="60" width="40" height="120" fill="#5c9cff" rx="4" />
              <rect x="210" y="90" width="40" height="90" fill="#5c9cff" rx="4" />
              <rect x="260" y="110" width="40" height="70" fill="#5c9cff" rx="4" />
              <rect x="310" y="70" width="40" height="110" fill="#5c9cff" rx="4" />
      ...
      <div class="col-4 h-100 overflow-auto">
        <div class="lucien-card h-100">
          <div class="lucien-card-inner shadow">
            ...
            <h4 class="text-info border-bottom border-secondary border-opacity-25 pb-2 mb-3 mt-5">Contabilidade</h4>
            <div class="mb-4">
